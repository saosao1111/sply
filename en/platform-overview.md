...
SPLY is a launch platform for BNB Smart Chain that covers more than token deployment. It coordinates:
...
That makes SPLY both protocol infrastructure and product infrastructure.
...
See [Deployed Contract Addresses](./deployed-contract-addresses.md) for current addresses.
